...
public class SongServiceImpl extends ServiceImpl<SongMapper, Song> implements SongService {
    ...
    public R updateSongUrl(MultipartFile urlFile, int id) {
        ...
        //删除原文件，减少内存负载
        String oldFilePath = System.getProperty("user.dir") +songMapper.selectSongUrl((long) id);
    ...
    public R updateSongPic(MultipartFile urlFile, int id) {
        ...
        //删除原文件，减少内存负载
        String oldFilePath = System.getProperty("user.dir") +songMapper.selectSongPic((long) id);
        File file2= new File(oldFilePath);
        String defaultPic = "/img/songPic/songDefault.jpg";
        if (defaultPic.equals(songMapper.selectSongPic((long) (id))) ){}
        else {
            if(file2.exists()){
                file2.delete();
            }
