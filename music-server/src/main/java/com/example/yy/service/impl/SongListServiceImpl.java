...
import com.example.yy.mapper.SongListMapper;
...
public class SongListServiceImpl extends ServiceImpl<SongListMapper, SongList> implements SongListService {
    ...
    public R addSongList(SongListRequest addSongListRequest) {
        ...
        String pic = "/img/songListPic/songListDefault.jpg";
        songList.setPic(pic);
    ...
    public R updateSongListImg(MultipartFile avatarFile, int id) {
        ...
        //删除原文件，减少内存负载
        String oldFilePath = System.getProperty("user.dir") +songListMapper.selectSongListPic((long) id);
        File file2= new File(oldFilePath);
        String defaultPic = "/img/songListPic/songListDefault.jpg";
        if (defaultPic.equals(songListMapper.selectSongListPic((long) (id))) ){}
        else {
            if(file2.exists()){
                file2.delete();
            }
