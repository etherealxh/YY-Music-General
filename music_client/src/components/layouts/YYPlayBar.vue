<template>
    <div class="play-bar" :class="{ show: !toggle }">
        <div class="fold" :class="{ turn: toggle }">
            <y-y-icon :icon="iconList.ZHEDIE" @click="toggle = !toggle"></y-y-icon>
        </div>
        <!--播放进度-->
        ...
        <div class="control-box">
            ...
            <div class="song-ctr">
                <y-y-icon class="yy-play-show" :icon="playStateList[playStateIndex]" @click="changePlayState"></y-y-icon>
                <!--上一首-->
                <y-y-icon class="yy-play-show" :icon="iconList.SHANGYISHOU" @click="prev"></y-y-icon>
                <!--播放-->
                <y-y-icon :icon="playBtnIcon" @click="togglePlay"></y-y-icon>
                <!--下一首-->
                <y-y-icon class="yy-play-show" :icon="iconList.XIAYISHOU" @click="next"></y-y-icon>
                <!--音量-->
                <el-dropdown class="yy-play-show" trigger="click">
                    <y-y-icon v-if="volume !== 0" :icon="iconList.YINLIANG"></y-y-icon>
                    <y-y-icon v-else :icon="iconList.JINGYIN"></y-y-icon>
                    <template #dropdown>
                        <el-dropdown-menu>
                            <el-slider class="yy-slider" style="height: 150px; margin: 10px 0" v-model="volume"
          ...
          "
                ></y-y-icon>
                <!--歌曲列表-->
                <y-y-icon :icon="iconList.LIEBIAO" @click="changeAside"></y-y-icon>
            </div>
        </div>
    </div>
